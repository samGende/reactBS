    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity style={styles.buttons} onPress={navigation.replace("Checkin")}>
          ...
          source={require('../assets/mycollection/png/001-in-time.png')}></Image>
        </TouchableOpacity>
        <TouchableOpacity style={styles.buttons}>
          <Text style={styles.buttonsText}>Create Workout</Text>
          <Image style={{width: 40, height:40}}
          source={require('../assets/mycollection/png/002-workout.png')}></Image>
        </TouchableOpacity>
               <TouchableOpacity style={styles.buttons}>
          <Text style={styles.buttonsText}>Progress</Text>
          <Image style={{width: 40, height:40}}
          source={require('../assets/mycollection/png/003-goal.png')}></Image>
        </TouchableOpacity>
        <TouchableOpacity style={styles.buttons}>
          <Text style={styles.buttonsText}>Record Workout</Text>
          <Image style={{width: 40, height:40}}
          source={require('../assets/mycollection/png/004-edit.png')}></Image>
        </TouchableOpacity>
      </View>
    </View>
  )
